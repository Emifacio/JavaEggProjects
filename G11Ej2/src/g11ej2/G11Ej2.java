...
* y posición agua (la posición del tambor donde se encuentra el agua). Estas dos posiciones, 
...
* 9• ronda(): cada ronda consiste en un jugador que se apunta con el revolver de agua y aprieta el gatillo.
